				...
				<div className="text-center mb-8">
					...
					<div className="flex items-center justify-center gap-4 sm:gap-6 md:gap-8 mb-4">
						...
						{/* <div className="relative group">
							<div className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 lg:w-28 lg:h-28 rounded-full overflow-hidden border-2 border-gradient-to-r from-blue-400 to-purple-500 p-[2px] bg-gradient-to-r from-blue-400 to-purple-500">
								<img 
									src="image.JPG" 
									alt="Profile" 
							...
							<div className="relative p-8">
								...
								<div className="flex justify-center">
									<div className="inline-flex items-center gap-1.5 px-4 py-1 rounded-full bg-gradient-to-r from-blue-500/10 to-purple-500/10 border border-blue-500/20 group-hover:border-blue-400/30 transition-colors">
										...
										<span className="text-blue-400 text-sm font-medium">Future App</span>
									</div>
								</div>
								...
								<div className="text-center mt-6">
									...
									<p className="text-gray-400 mb-6 group-hover:text-gray-300 transition-colors">Your Personal Flutter Roadmap Companion</p>
