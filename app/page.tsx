			...
			<header className="fixed top-0 left-0 w-full z-50">
				...
				<div className="hidden md:block bg-transparent">
					<div className="max-w-6xl mx-auto px-6 py-3 flex justify-center">
						<div
							className={`flex items-center justify-center bg-gray-900/80 backdrop-blur-md rounded-full shadow-xl px-6 py-3 transition-all duration-500 ${isScrolled ? "scale-100 opacity-100" : "scale-95 opacity-90"}`}
						>
				...
				<div className="md:hidden">
					{/* Mobile AppBar */}
					<div className="flex w-full items-center justify-between px-4 py-3 bg-gray-900/90 backdrop-blur-md transition-all duration-500">
						<button
					...
					{menuOpen && (
						<div className="w-full bg-gray-900/90 backdrop-blur-md px-4 py-4 space-y-4 text-left">
							{navItems.map((item) => (
								<a
									key={item}
									href={`#${item}`}
